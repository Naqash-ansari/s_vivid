                    ...
                    <ul className="space-y-8">
                        <li className="text-sm leading-6">
                            <div className="relative group">
                                ...
                                <a href="nyewest" className="cursor-pointer">
                                    <div
                        ...
                        <li className="text-sm leading-6">
                            <div className="relative group">
                                ...
                                <a href="m_cook" className="cursor-pointer">
                                    <div
                                        className="relative p-6 space-y-6 leading-none rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
                                        <div className="flex justify-center items-center text-center w-full">
                                            <Image width={150} height={100} src={img} alt="image" />
                    ...
                    <ul className="hidden space-y-8 sm:block">
                        ...
                        <li className="text-sm leading-6">
                            <div className="relative group">
                                ...
                                <a href="raga" className="cursor-pointer">
                                    <div
                                        className="relative p-6 space-y-6 leading-none rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
                                        <div className="flex justify-center items-center text-center w-full">
                                            <Image width={150} height={100} src={img} alt="image" />
                    ...
                    <ul className="hidden space-y-8 lg:block">
                        ...
                        <li className="text-sm leading-6">
                            <div className="relative group">
                                ...
                                <a href="n_schulman" className="cursor-pointer">
                                    <div
                                        className="relative p-6 space-y-6 leading-none rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
                                        <div className="flex justify-center items-center text-center w-full">
                                            <Image width={150} height={100} src={img} alt="image" />
                        ...
                        <li className="text-sm leading-6">
                            <div className="relative group">
                                ...
                                <a href="tyanadella" className="cursor-pointer">
                                    <div
                                        className="relative p-6 space-y-6 leading-none rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
                                        <div className="flex justify-center items-center text-center w-full">
                                            <Image width={150} height={100} src={img} alt="image" />
