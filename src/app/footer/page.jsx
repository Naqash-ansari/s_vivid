...
const Footer = () => {
    return (
        <footer className="relative py-10 bg-black text-white">
            ...
            <div className="px-6 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
                    ...
                    <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
                        ...
                        {/* Categories */}
                        <div>
                            <h4 className="font-semibold tracking-wide mb-2">Category</h4>
                            <ul className="space-y-2 text-sm">
                                <li><Link href="/product/SignProduct/1" className="hover:text-amber-500">Shop Signs</Link></li>
                                <li><Link href="/product/SignProduct/2" className="hover:text-amber-500">3D Signs</Link></li>
                                <li><Link href="/product/SignProduct/3" className="hover:text-amber-500">Neon</Link></li>
                                <li><Link href="/product/SignProduct/4" className="hover:text-amber-500">Projection Signs</Link></li>
                            </ul>
                        </div>

                        {/* Pages */}
                        <div>
                            <h4 className="font-semibold tracking-wide mb-2">Pages</h4>
                            <ul className="space-y-2 text-sm">
                        ...
                        {/* Contact Info */}
                        <div>
                            <h4 className="font-semibold tracking-wide mb-2">Get in Touch</h4>
                            <ul className="space-y-2 text-sm">
                                <li>
                                    <a href="tel:+447728339751" className="hover:text-amber-500">
                                        +44 7728 339751
                                    </a>
                                </li>
                                <li>
                                    <a href="mailto:chwaseem1985@gmail.com" className="hover:text-amber-500">
                                        chwaseem1985@gmail.com
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                <div className="flex flex-col justify-between pt-5 pb-10 border-t border-amber-500 sm:flex-row">
                    <p className="text-sm text-gray-300">
                        © {new Date().getFullYear()} Sign Vivid. All rights reserved.
                    </p>
